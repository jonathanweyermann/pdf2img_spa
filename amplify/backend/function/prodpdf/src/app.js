...
const S3_BUCKET = 'quiztrainer-quiz-images-prod'
...
app.use(function(req, res, next) {
  res.header("Access-Control-Allow-Origin", "https://d3mj1nbhrzlbf6.cloudfront.net")
...
app.get('/prodpdfs', function(req, res) {
  // Add your code here
...
app.put('/prodpdfs', function(req, res) {
  // Add your code here
...
app.delete('/prodpdfs', function(req, res) {
  // Add your code here
